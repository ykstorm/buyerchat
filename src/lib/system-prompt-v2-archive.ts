// system-prompt-v2-archive.ts — V2 LEGACY (frozen)
//
// Frozen 2026-04-24 when system-prompt.ts was rewritten to v3 (14-PART
// Mama spec + Emotional Decision Engine). This file preserves the v2
// 18-PART body verbatim so we can A/B against v3 by setting
// `ChatSession.systemPromptVersion = 'v2'` (or env override
// `SYSTEM_PROMPT_VERSION=v2`).
//
// Signature is identical to buildSystemPrompt — drop-in compatible.
// Do NOT edit this file. Bug fixes go into system-prompt.ts (v3); v2
// stays frozen so historical sessions can be replayed exactly.
//
// All PART 8.5 anti-fabrication rules (#6 FABRICATED_STAT, #7
// FABRICATED_PRICE, #8 amenity GUARD_LIST, #9 FAKE_VISIT_CLAIM) are
// preserved here verbatim — they remain active for v2 sessions.

import type { RetrievedChunk } from '@/lib/rag/retriever'
import type { Persona } from '@/lib/intent-classifier'

export function SYSTEM_PROMPT_V2_LEGACY(ctx: {
  projects: unknown[]
  localities: unknown[]
